...
// Images
import Picture from "../../assets/img/Ai.png"; // Ye fix background image rahegi
...
const Ai1 = () => {
  ...
  if (loading) return <div className="min-h-[60vh] flex items-center justify-center text-white bg-gray-900">Loading Hero Section...</div>;
  if (!blog) return null;
    ...
    <div className="text-gray-900 w-full">
      <section
        className="
          ...
          text-white
        "
        // --- CHANGE HERE: Sirf static Picture use ho rahi hai ---
