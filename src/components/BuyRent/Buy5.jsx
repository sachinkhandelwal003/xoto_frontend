...
const OurProperty = () => {
  ...
  const PropertyCard = ({ property }) => (
    /* Changed fixed w-[393px] to max-w-[393px] and w-full */
    <div className="w-full max-w-[393px] mx-auto h-[519px] bg-white rounded-[24px] shadow-[0px_20px_40px_rgba(0,0,0,0.12)] overflow-hidden relative">
      ...
      <div className="p-6">
        ...
        <button onClick={() => setOpenModal(true)} className="w-full mt-8 h-[48px] rounded-lg bg-[#5C039B] text-white text-[16px] font-medium transition-transform hover:scale-[1.02]">
          Show Details
        </button>
      </div>
    </div>
  ...
  return (
    <>
      ...
      <section className="relative pt-10 pb-20 md:pb-40 bg-[var(--color-body)] overflow-hidden z-20">
        <img src={waveint4} alt="" className="absolute -bottom-[150px] md:-bottom-[350px] left-0 w-full object-cover" />
        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          {/* MOBILE: Swiper shows on screens smaller than md (768px) */}
          ...
          {/* TABLET & DESKTOP: Grid shows on md and up */}
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative w-full sm:w-32">
                    <select name="country_code" value={formData.country_code} onChange={handleChange} className="premium-input pl-10 pr-2 appearance-none cursor-pointer">
                  ...
                  <div className="relative flex-1">
                    <input name="mobile" type="text" inputMode="numeric" value={formData.mobile} onChange={handleChange} placeholder={t("form.phone")} required className="premium-input pl-12" />
