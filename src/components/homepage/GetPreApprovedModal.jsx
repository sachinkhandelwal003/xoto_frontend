...
export default function GetPreApprovedModal({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="relative w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden text-black">
        ...
        <div className="relative bg-white rounded-3xl px-8 py-10">
          ...
          <div className="space-y-6 text-sm">
            ...
            {/* LOCATION */}
            <div>
              <label className="block mb-1 text-sm font-medium text-black text-left">
