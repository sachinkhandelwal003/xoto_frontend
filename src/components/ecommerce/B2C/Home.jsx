...
const Ecommerce = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      {/* Hero Section */}
      <div
        className="relative h-[85vh] bg-cover bg-center overflow-hidden"
        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="container mx-auto px-6 md:px-12 py-16">
            <motion.div
              ...
              className="max-w-2xl"
            >
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white px-4 py-2 rounded-md text-sm font-semibold mb-6">
                <span className="w-2 h-2 bg-[var(--color-primary)] rounded-full"></span>
                Premium Interior Solutions
              </div>
              
              <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight mb-6">
                Redefine Your <span className="text-[var(--color-primary)]">Living Space</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.button
                  ...
                  className="px-8 py-4 bg-[var(--color-primary)] text-white font-semibold rounded-md shadow-lg hover:shadow-xl transition-all duration-300 hover:opacity-90"
                >
                  Explore Collections
                </motion.button>
                ...
                <motion.button
                  ...
                  className="px-8 py-4 bg-transparent text-white font-semibold rounded-md border-2 border-white hover:bg-white hover:text-[var(--color-primary)] transition-all duration-300"
                >
                  Become a Vendor
                </motion.button>
              </div>
