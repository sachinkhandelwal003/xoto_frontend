...
const Category = () => {
  ...
  const categories = [
    ...
    { id: 2, name: "Artificial grass carpet", icon: <FaCouch />, color: "from-blue-500 to-cyan-400" },
    { id: 3, name: "Tiles", icon: <FaBed />, color: "from-emerald-500 to-teal-400" },
    { id: 4, name: "Flooring", icon: <FaUtensils />, color: "from-amber-500 to-orange-400" },
    { id: 5, name: "Gazibos & Pergolas", icon: <FaDoorClosed />, color: "from-rose-500 to-pink-400" },
    { id: 6, name: "Outdoor Sofa set", icon: <FaShoePrints />, color: "from-indigo-500 to-purple-400" },
    { id: 7, name: "Curtains", icon: <FaBook />, color: "from-violet-500 to-purple-400" },
    { id: 8, name: "TV Units", icon: <FaTv />, color: "from-gray-600 to-gray-400" },
    { id: 9, name: "Artificial Plants", icon: <FaRecycle />, color: "from-fuchsia-500 to-pink-400" },
    { id: 10, name: "BBQ & Grill", icon: <FaChair />, color: "from-green-500 to-emerald-400" },
    { id: 11, name: "Fountains", icon: <FaCouch />, color: "from-yellow-500 to-amber-400" },
    { id: 12, name: "Lights", icon: <FaBook />, color: "from-red-500 to-orange-400" },
    { id: 13, name: "Swimming Pool & Accesories", icon: <FaFire />, isDeal: true, color: "from-red-500 to-pink-500" },
    { id: 14, name: "Bar Units  ", icon: <FaUsers />, color: "from-purple-600 to-blue-500" },
