  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" 
      ...
      <div className={`w-full max-w-md transition-all duration-500 ${isFocused ? 'scale-105' : 'scale-100'}`}>
        {/* "Sign in as Pro" Header */}
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold text-white mb-2">Sign in as Pro</h2>
          <p className="text-white/80">Access your professional dashboard</p>
        </div>
        ...
        >
          <form className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors duration-300"
              >
                Sign in
              </button>
            </div>
